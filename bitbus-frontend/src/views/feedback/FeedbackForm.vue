...
<template>
    ...
    <div class="p-10 relative overflow-x-auto">
        <div class="max-w-lg grid mx-auto grid-cols-12">
            <h1 class="col-span-12 text-3xl text-green-900 dark:text-white mb-5">Informar Feedback</h1>

            <div class="mb-5 col-span-12">
                <label for="nome" class="block mb-2 text-sm font-medium text-green-900 dark:text-white">Nome</label>
            ...
            <div class="mb-5 col-span-12">
                <label for="avaliacao"
                    class="block mb-2 text-sm font-medium text-green-900 dark:text-white">Avaliação</label>
            ...
            <div class="mb-5 col-span-12">
                <label for="descricao" class="block mb-2 text-sm font-medium text-green-900 dark:text-white">Conte mais
