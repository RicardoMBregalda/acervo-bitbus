...
<template>
    ...
    <div class="p-10 sm:ml-64 relative overflow-x-auto">
        <div class="max-w-lg grid mx-auto grid-cols-12">
            <h1 class="col-span-12 text-3xl text-green-900 dark:text-white mb-5">Cadastrar Participante</h1>
            ...
            <div class="mb-5 col-start-4 col-span-9">
                <label :for="identificacaoLabel.toLowerCase()"
                    class="block mb-2 text-sm font-medium text-green-900 dark:text-white">{{ identificacaoLabel
                    }}</label>
