...
<template>
    ...
    <div class="p-10 sm:ml-64 relative overflow-x-auto ">
        ...
        <div class="max-w-5xl grid mx-auto grid-cols-12">
            <h1 class="col-span-12 text-3xl text-teal-900 dark:text-white mb-5">Cadastrar Oficina</h1>
            ...
            <h2 class="col-span-12 text-2xl text-teal-900 dark:text-white my-5">Participantes</h2>
